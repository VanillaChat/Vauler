...
login-sub = Your servers, your friends, your conversations — right where you left them.
...
# register
register-headline = Where simplicity and privacy meet.
...
# reset password
reset-headline = Forgot your way back?
reset-sub = Happens to the best of us. Drop your email and we'll send a fresh link.
reset-title = Reset password.
reset-subtitle = Enter your email — we'll send a link to set a new one.
reset-submit = Send reset link
reset-back = Back to sign in
reset-remembered = Remembered it?
reset-sent-title = Check your inbox.
reset-sent-msg = If { $email } matches an account, a reset link is on its way.
reset-wrong-email = Wrong email?
