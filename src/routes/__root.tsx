import { Link, Outlet, createRootRoute, useNavigate, useRouterState } from '@tanstack/solid-router';
  ...
  return (
    <div class="relative" ref={wrapperRef}>
      ...
      >
        ...
        <i class={`fa-solid fa-chevron-down text-[10px] opacity-60 transition-transform ${open() ? 'rotate-180' : ''}`} />
      </button>
      ...
      <Show when={open()}>
        ...
        >
          <div class="px-4 py-3 border-b border-stone-200 dark:border-stone-800">
            ...
            <div class="text-xs text-stone-500 dark:text-stone-400 truncate">{props.session.account.email}</div>
          </div>
          <button
            type="button"
            role="menuitem"
